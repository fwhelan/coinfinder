...
{
    public:
        static void run(const DataSet& dataset, const std::string& phylogeny, const std::string path);
	...
	static std::string calc_common_ancestor(const std::string& phylogeny, const std::vector<std::string>& edges_union, std::string path);
